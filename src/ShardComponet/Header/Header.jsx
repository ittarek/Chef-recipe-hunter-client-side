    ...
    <Container className="d-flex position-sticky-top ">
      ...
      <Navbar.Collapse>
        <Nav
          ...
          navbarScroll
        >
          <NavLink className="nav-link text-decoration-none" style={navLinkStyle} to="/">
            {" "}
            Home
          </NavLink>

          <NavLink  to="/destination" style={navLinkStyle} className="mx-2    nav-link text-decoration-none">
            {" "}
            Destination
          </NavLink>

          <NavLink className="text-decoration-none nav-link" style={navLinkStyle} to="/blog">
            {" "}
            Blog
          </NavLink>

          <NavLink  to="/contact" style={navLinkStyle} className="mx-2 nav-link text-decoration-none">
            {" "}
            Contact
          </NavLink>
          ...
          {user?.email ? (
            <NavLink
              ...
              style={navLinkStyle}
              className="btn btn-outline btn-success  nav-link"
            >
              LogOut
            </NavLink>
          ) : (
